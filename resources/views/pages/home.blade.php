    ...
    <section class="bg-[#FCF8F1] bg-opacity-30 py-10 lg:py-14 ">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    <h1 class="mt-4 text-4xl font-bold text-black text-justify lg:mt-8 sm:text-5xl xl:text-7xl">Sistem pendukung keputusan Santri terbaik</h1>
                    <p class="mt-4 text-base text-black lg:mt-8 sm:text-xl"> PPTQ AL KAUKAB</p>
                </div>
                <div>
...
<section class="bg-white text-gray-900">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-6 text-center">Langkah-langkah Metode Simple Additive Weighting (SAW)</h1>
